...
![Different channels emphasize different aspects of the raw image. The image was taken at Yuanyang, Yunnan, China.](<../.gitbook/assets/conv\_5 (1).png>)
...
![](<../.gitbook/assets/conv\_42 (4) (4) (5) (5) (5) (5) (1) (1).png>)
...
![](<../.gitbook/assets/conv\_11 (1).png>)\_
...
![](https://github.com/ztlevi/Machine\_Learning\_Questions/tree/26cb30cb7a3ec95f737534585c8ae80567d03d7b/assets/conv\_13.md)
...
![](<../.gitbook/assets/1KGrCz7aav02KoGuO6znO0w (3) (3) (4) (4) (4) (4) (1) (1).gif>)
...
![Matrix multiplication for convolution: from a Large input image (4 x 4) to a Small output image (2 x 2).](<../.gitbook/assets/conv\_18 (1).jpeg>)
...
![Matrix multiplication for convolution: from a Small input image (2 x 2) to a Large output image (4 x 4).](<../.gitbook/assets/conv\_19 (1).png>)
...
![](<../.gitbook/assets/conv\_23 (1).png>)

![](<../.gitbook/assets/conv\_24 (1).gif>)The standard convolution.

The dilated convolution follows:

![](<../.gitbook/assets/conv\_25 (1).png>)

When _l = 1_, the dilated convolution becomes as the standard convolution.

![](<../.gitbook/assets/conv\_26 (1).gif>)The dilated convolution.
...
![](<../.gitbook/assets/conv\_27 (1).jpeg>)Receptive field for the dilated convolution. We essentially observe a large receptive field without adding additional costs.
...
![](<../.gitbook/assets/conv\_28 (1).png>)A Sobel kernel can be divided into a 3 x 1 and a 1 x 3 kernel.
...
![](<../.gitbook/assets/conv\_29 (1).png>)Standard convolution with 1 channel.
...
![](<../.gitbook/assets/conv\_30 (1).png>)Spatially separable convolution with 1 channel.
...
![](https://github.com/ztlevi/Machine\_Learning\_Questions/tree/26cb30cb7a3ec95f737534585c8ae80567d03d7b/docs/.../.gitbook/assets/conv\_31.png)
...
![Standard 2D convolution.](<../.gitbook/assets/conv\_42 (4) (4) (5) (5) (5) (5) (1) (2).png>)
...
![Grouped convolution with 2 filter groups.](<../.gitbook/assets/conv\_43 (1).png>)

Above is the illustration of grouped convolution with 2 filter groups. In each filter group, the depth of each filter is only half of the that in the nominal 2D convolutions.

They are of depth $$D_{in} / 2$$. Each filter group contains $$D_{out} /2$$ filters. The first filter group (red) convolves with the first half of the input layer ($$[:, :, 0:D_{in}/2]$$), while the second filter group (blue) convolves with the second half of the input layer ($$[:, :, D_{in}/2:D_{in}]$$). As a result, each filter group creates $$D_{out}/2$$ channels. Overall, two groups create $$2 \times D_{out}/2 = D_{out}$$ channels. We then stack these channels in the output layer with $$D_{out}$$ channels.
...
![Channel shuffle.](<../.gitbook/assets/conv\_49 (1).png>)
...
* “Convolution arithmetic animation” ([Link](https://github.com/vdumoulin/conv\_arithmetic))
