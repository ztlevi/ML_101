...
![KNN](<../.gitbook/assets/knn (1).png>)

### Naive Bayes

#### TODO explain formula

* Naive Bayes (NB) is a supervised learning algorithm based on applying [Bayes' theorem](https://en.wikipedia.org/wiki/Bayes'\_theorem)
...
*   KKT condition:
    ...
    * Thus, the corresponding KKT conditions(Karush–Kuhn–Tucker\_conditions) are as following:
...
![svm](<../.gitbook/assets/svm (1).png>)

## Decision tree

![Image result for Decision tree image](<../.gitbook/assets/B03905\_05\_01-compressor (1).png>)
...
![Image result for Random forest](<../.gitbook/assets/Architecture-of-the-random-forest-model (1).png>)
