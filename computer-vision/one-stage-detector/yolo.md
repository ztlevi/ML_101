...
![yolo v1 structure](<../../.gitbook/assets/yolov1 (1).png>)
...
![output formula](<../../.gitbook/assets/yolo\_formula1 (1).png>)
...
Previously: Each object in training image is assigned to grid cell that contains that object's midpoint. Grid: 3x3, Output: 3x3x(5+3), 5+3 means ($$p_c, x, y, h, w, c1, c2, c3$$)
...
![](https://cdn-images-1.medium.com/max/1760/1\*krGqonOLMzSE\_PWqH\_LvQA.jpeg)
...
![img](https://cdn-images-1.medium.com/max/1760/1\*gyOSRA\_FDz4Pf5njoUb4KQ.jpeg)
...
![](<../../.gitbook/assets/yolo\_Jaccard\_index (1).jpg>)
...
![](<../../.gitbook/assets/yolo\_clustering (1).jpg>)
...
![img](<../../.gitbook/assets/yolov3 (1).png>)
...
![img](https://cdn-images-1.medium.com/max/800/1\*Yc\_OJIXOoV2WaGQ6PqhTXA.png)
